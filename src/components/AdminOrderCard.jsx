...
export const AdminOrderCard = ({ order }) => {
    ...
    const { id, status, firstName, lastName, email, datePlaced, products, total, paymentId, paymentType, paymentAmt, paymentURL} = order;
                    ...
                    <table className="orderPayments">
                        ...
                        <tbody>
                            <tr key={`orderPayments${id}`}>
                                ...
                                <td>{paymentId}</td>
                                <td><a href={paymentURL}>Order Receipt</a></td>
                            </tr>
                        </tbody>
                    </table>
                )
